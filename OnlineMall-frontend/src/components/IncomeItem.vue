  ...
  <div>
    ...
    <div class="body">
      ...
      <div style="display: inline-block;line-height: 40px;padding: 20px" >
        <table>
          <tr>
            <th><span style="color: #ffffff">Product id</span></th>
            <th style="width: 300px"><span style="color: #ffffff">Product name</span></th>
            <th><span style="color: #ffffff">Sales volume</span></th>
          </tr>
          <tr>
